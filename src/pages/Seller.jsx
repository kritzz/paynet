    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-4xl mx-auto p-6">
                <div className="bg-gradient-to-r from-orange-500 to-orange-400 rounded-lg shadow-lg p-8 mb-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {[
                                ...
                                { field: "average_rating", label: "Average Rating" }, // New field added
                            ].map(({ field, label }) => (
                                <button
                                    key={field}
                                    onClick={() => handleSort(field)}
                                    className={`cursor-pointer flex items-center px-3 py-1.5 rounded text-sm ${sortField === field
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center mt-2">
                                                    {[...Array(5)].map((_, i) => (
                                                        <FaStar
                                                            key={i}
                                                            className={`w-5 h-5 ${i < Math.round(seller.average_rating)
                                                                ? "text-orange-500"
                                                                : "text-gray-200"
                                                                }`}
                                                        />
                        ...
                        {totalPages > 1 && (
                            <div className="flex justify-center mt-8 space-x-2">
                                ...
                                {[...Array(Math.min(5, totalPages))].map((_, i) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-10 h-10 cursor-pointer rounded-full ${page === pageNum
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 cursor-pointer rounded ${page === totalPages
                                        ? "bg-gray-100 text-gray-400 cursor-not-allowed"
                                        : "bg-white text-orange-500 hover:bg-orange-50"
                                        }`}
                                >
