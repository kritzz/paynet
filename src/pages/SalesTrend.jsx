...
export default function SalesTrendPage() {
  ...
  const capOutliers = (data, field, capPercentile = 85) => {
    ...
    const capValue =
      sortedValues[Math.floor((capPercentile / 100) * sortedValues.length)];
  ...
  const salesChange =
    data.length > 1
      ? calculatePercentageChange(
          data[0].total_sales,
          data[data.length - 1].total_sales
        )
      : 0;
  const ordersChange =
    data.length > 1
      ? calculatePercentageChange(
          data[0].total_orders,
          data[data.length - 1].total_orders
        )
      : 0;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="mt-6 text-gray-400">Loading sales trend...</p>
          </div>
        )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-[#1a1a1a] p-6 rounded-lg shadow-md border border-[#333333]">
                ...
                <p className="text-gray-400 mt-2">
                  This represents the percentage change in total sales between
              ...
              <div className="bg-[#1a1a1a] p-6 rounded-lg shadow-md border border-[#333333]">
                ...
                <p className="text-gray-400 mt-2">
                  This represents the percentage change in total orders between
                  the first and last recorded dates.
                </p>
              </div>
            </div>
